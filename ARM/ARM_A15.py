...
class ARM_A15_L1_Cache(Cache):
    ...
    def __init__(self, options=None):
        super(ARM_A15_L1_Cache, self).__init__()
        pass
...
class ARM_A15_L2_Cache(Cache):
    ...
    def __init__(self, options=None):
        super(ARM_A15_L2_Cache, self).__init__()
        pass
...
class A15_System(System):

    def __init__(self, options=None):
        super(A15_System, self).__init__()
...
############################################################
        self.cpu = ARM_A15_CPU()

############################################################
## Caches - definidas em caches.py
############################################################
        self.cpu.icache  = ARM_A15_L1_Cache()
        self.cpu.dcache  = ARM_A15_L1_Cache()
        self.cpu.l2cache = ARM_A15_L2_Cache()
